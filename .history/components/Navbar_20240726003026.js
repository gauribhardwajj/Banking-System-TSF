    ...
    <div className={`h-20 bg-blue-900 border-b-2 shadow-md z-50`}>
      <div className="w-screen  px-5 md:px-0 md:max-w-screen-2xl xl:max-w-screen-xl mx-auto flex items-center justify-between h-full">
        ...
        <ul className="flex items-center space-x-4 sm:space-x-7">
          <li
            onClick={() => router.push("/")}
            className={`link text-gray-200 hover:text-white text-sm sm:text-base ${
          ...
          <li
            ...
            className={`link text-gray-200 hover:text-white ${
          ...
          <li
            ...
            className={`px-2 py-2 cursor-pointer text-white hover:text-white bg-purple-500 hover:bg-purple-700 border-0 ${
