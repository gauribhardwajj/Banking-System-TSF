        ...
        <div className="flex justify-between items-center p-5">
          ...
          <ul className="flex gap-5">
            <li
              ...
              className="link cursor-pointer hidden lg:block text-sm md:text-xl text-white hover:text-gray-300 transition"
            >
              Create User
            </li>
            <li
              onClick={() => router.push("/users")}
              className="link cursor-pointer text-sm md:text-xl text-white hover:text-gray-300 transition hidden sm:block"
            >
              Users
            </li>
            <li
              onClick={() => router.push("/transferMoney")}
              className="link cursor-pointer text-sm md:text-xl text-white hover:text-gray-300 transition"
            >
              Transfer Money
            </li>
          </ul>
