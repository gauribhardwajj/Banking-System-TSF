    ...
    <div className="bg-home bg-cover bg-center h-screen overflow-hidden text-white">
      ...
      <div className="flex flex-col h-full justify-between">
        ...
        <div className="justify-center flex mb-20 gap-5">
            <a><img src="/github.png" href="https://github.com/gauribhardwajj" className="w-7"/></a>
            <a><img src="/linkedin.png" href="https://www.linkedin.com/in/gauriibhardwajj/" className="w-7"/></a>
        </div>
      </div>
    </div>
  );
